...
def student_dashboard():
    ...
    with st.container(border=True):
        ...
        with c2:
            ...
            st.caption("Your academic dashboard is ready.")
    ...
    metric_cols[0].metric("Subjects", total_subjects)
    metric_cols[1].metric("Classes", total_classes)
    metric_cols[2].metric("Attendance", f"{attendance_rate}%")
